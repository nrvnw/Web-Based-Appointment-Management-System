...
<body>
    <div class="container">
        ...
        <p class="lbl_pnd">Pending Request</p>
    ...
    if(isset($_POST['receipt_number'])) {
        ...
        $sql = "SELECT * FROM appointments WHERE receipt_number = '$receipt_number'";
        ...
        if(mysqli_num_rows($result) > 0) {
            ...
            while($row = mysqli_fetch_assoc($result)) {
                echo "<tr><td>" . $row['receipt_number'] . "</td><td>" . $row['date'] . "</td><td>" . $row['time'] . "</td><td>" . $row['requirements'] . "</td><td>" . $row['name'] . "</td><td>" . $row['email'] . "</td><td>" . $row['phone'] . "</td><td><a href='o_pending.php?id=" . $row['id'] . "' class=\"act\">Open</a></td></tr>";
            }
            echo "</table>";
        }
        else {
    ...
    // select all the data from the appointments table
