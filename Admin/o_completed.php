...
<head>
    ...
    <link rel="stylesheet" href="o_completed.css">
...
<?php
    ...
    if(isset($_GET['id'])) {
      ...
      $id = $_GET['id'];
      $sql = "SELECT * FROM completed WHERE id=$id";
      ...
      if(mysqli_num_rows($result) > 0) {
        ...
        echo "<p class=\"lbl_cmpt\">Completed</p>";
        ...
        <button class="PrvFile" onclick="window.open(\'preview_pdfCmpltd.php?id=' . $id . '\', \'_blank\'); return false;">Preview PDF</button>
        </form>';
    ...
    echo"<a href=\"Completed.php\" class=\"bck\">Back</a>";
